...
function App() {
  ...
  const templateColumns = [
    ...
    { title: "操作", render: (_: unknown, item: Template) => <Space><Button onClick={() => void showColumns(item)}>查看列</Button><Button onClick={() => void showPreview(item)}>预览</Button><Button type="primary" onClick={() => void configureTemplate(item)}>配置模式 A</Button></Space> },
  ];
